...
export default function TransactionSearch() {
  return (
    <div className="min-h-screen flex flex-col justify-center items-center bg-gray-100">
      ...
      {/* Footer */}
      <footer className="absolute bottom-4 left-4 text-gray-500">
        <a href="https://twitter.com/WavyNode" className="flex items-center space-x-1">
          <img src="/path/to/twitter-logo.png" alt="Twitter" className="h-4" />
          <span>@WavyNode</span>
        </a>
      </footer>
    </div>
